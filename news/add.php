...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO news (image, link, title, description) VALUES (?, ?, ?, ?)";
  $stmt = mysqli_stmt_init($con);

  if (mysqli_stmt_prepare($stmt, $sql)) {
    // Bind the parameters
    mysqli_stmt_bind_param($stmt, "ssss", $targetFilePath, $apiPath, $title, $description);
              ...
              <form class="needs-validation" novalidate action="" method="post" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label>Title</label>
                      <input type="text" class="form-control" placeholder="Enter Title" name="title" pattern="{3,60}"
                        required>
                    ...
                    <div class="form-group">
                      ...
                      <textarea rows="10" type="text" class="form-control" placeholder="Enter Description"
                        name="description" pattern="[A-Za-z]{3,}" required></textarea>
                      <div class="invalid-feedback">
