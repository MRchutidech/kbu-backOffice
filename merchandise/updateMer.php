        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
              <h6 class="m-0 font-weight-bold">Update Merchandise</h6>
            </div>
            ...
            <div class="card-body">
              <form class="needs-validation" novalidate action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Item name" name="itemsName"
                            pattern="{5,}" value="<?php echo $itemsName; ?>" required>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" step=0.25 class="form-control" placeholder="Enter price" name="price"
                            pattern="{5,}" value="<?php echo $price; ?>" required>
                          <div class="invalid-feedback">
                ...
                <div class="col-12 py-3 d-flex justify-content-end align-items-center">
                  ...
                  <div class="text-right">
                    <a href="merchandise.php" class="btn btn-danger">Cancel</a>
                  </div>
                </div>
              </form>
            </div>
