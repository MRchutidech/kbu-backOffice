...
if (isset($_POST['submit'])) {
  ...
  $checkQuery = "SELECT * FROM Players WHERE firstName = '$firstname' AND lastName = '$lastname'";
  $checkResult = mysqli_query($con, $checkQuery);
  $checkNum = "SELECT * FROM Players WHERE players_number = '$players_number'";
  $checkNumResult = mysqli_query($con, $checkNum);
  if (mysqli_num_rows($checkResult) > 0) {
    // Player already exists, show the modal
    echo "<script>
            alert('This player already exists in the team.');
            window.location.href = 'players.php'; // Redirect back to the players page
          </script>";
} elseif (mysqli_num_rows($checkNumResult) > 0) {
  echo "<script>
              alert('This player number already exists in the team.');
              window.location.href = 'players.php'; // Redirect back to the players page
            </script>";
  } else {
  $targetDir = "img/";
  ...
  $age = floor($ageSeconds / (365 * 24 * 60 * 60)); // Calculate age in years
    ...
    // Player doesn't exist, proceed with insertion
    $sql = "INSERT INTO Players (firstName, lastName, players_number, team_id, image, link, age, height, weight, appearances, scored, position, country, dob, joined, status)
            VALUES ('$firstname', '$lastname', '$players_number', '$team_id', '$targetFilePath', '$apiPath' , '$age', '$height', '$weight', '$appearances', '$scored', '$position', '$country', '$dob', '$joined', '$status')";
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
              <h6 class="m-0 font-weight-bold">Add Players</h6>
            </div>
            ...
            <div class="card-body">
              <form class="needs-validation" novalidate action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-12 py-3 d-flex justify-content-end align-items-center">
                  ...
                  <div class="text-right">
                    <a href="players.php" class="btn btn-danger">Cancel</a>
                  </div>
                </div>
              </form>
            </div>
