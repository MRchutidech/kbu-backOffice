...
$table_id = $_GET['updateid'];
$sql = "SELECT * FROM leaguetable WHERE table_id=?";
...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_stmt_prepare($stmt, $sql)) {
        // Bind the parameters
        mysqli_stmt_bind_param($stmt, "sssssi", $title, $season, $week, $image, $link, $table_id);
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
              <h6 class="m-0 font-weight-bold">Update Table</h6>
            </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Enter Competition name" name="title"
                        pattern="{3,}" value="<?php echo $title; ?>" required>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Enter Season EX:2022/2023" name="season"
                            pattern="\d{4}/\d{4}" value="<?php echo $season; ?>" required>
                          <div class="invalid-feedback">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" placeholder="Enter week" name="week" min="1"
                            max="38" value="<?php echo $week; ?>" required>
                          <div class="invalid-feedback">
