...
CREATE TABLE `auction` (
  ...
  `itemsName` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `leaguetable` (
  ...
  `season` varchar(9) COLLATE utf8_unicode_ci NOT NULL,
  `week` int(3) NOT NULL,
...
CREATE TABLE `match_team` (
  ...
  `match_team_status` varchar(4) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `member` (`member_id`, `mail`, `firstname`, `lastname`, `phone`, `address`, `subdistrict`, `district`, `province`, `country`, `postal_code`, `points`) VALUES
(1, 'supakritpetpon17@gmail.com', 'supakrit', 'petpon', '0954607529', 'home', '', '', '', '', '', 1),
(20, 'darkpiano999@hotmail.com', 'daewd', 'wdqd', '2122222222', 'awd', '', '', '', '', '', 0);
...
CREATE TABLE `order_member` (
  ...
  `shippingCost` double NOT NULL DEFAULT 19,
  `trackingNumber` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `shippingCompany` varchar(30) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Kerry',
...
INSERT INTO `order_member` (`order_id`, `member_id`, `orderDateTime`, `orderStatus`, `shippingCost`, `trackingNumber`, `shippingCompany`, `paymentTotalprice`, `paymentDateTime`, `paymentStatus`, `orderType`) VALUES
(1, 1, '2023-07-10 00:00:00', 'OrderPlaced', 1, '111111', 'ket', 1111, '2023-07-10 00:00:00', 'Waiting', 'Merchandise');
...
CREATE TABLE `player_score` (
  ...
  `players_id` int(11) NOT NULL,
  `opponentPlayers` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `match_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `predict` (
  ...
  `predict_status` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `record` (
  ...
  `member_id` int(11) NOT NULL,
  `description` text COLLATE utf8_unicode_ci NOT NULL,
  `activityType` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
