...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO auction (itemsName, image, link, startPrice, endDateTime, status) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($con, $sql);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, 'ssssss', $itemsName, $targetFilePath, $apiPath, $startPrice, $endDateTime, $status);
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Item name"
                                                name="itemsName" pattern="{5,}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step=0.25 class="form-control"
                                                placeholder="Enter price" name="startPrice" pattern="{5,}" required>
                                            <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="aucDate" required>
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" name="aucTime" required>
                                            <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input form-control" id="customFile"
                                            name="file" onchange="showFileName()" required>
                                ...
                                <div class="col-12 py-3 d-flex justify-content-end align-items-center">
                                    ...
                                    <div class="text-right">
                                        <a href="auction.php" class="btn btn-danger">Cancel</a>
                                    </div>
                                </div>
